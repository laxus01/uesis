...
} from "./chunk-45VTYA2N.js";
import {
  _objectWithoutPropertiesLoose,
  useThemeProps
} from "./chunk-P2JG6X25.js";
...
var useClearableField = (props) => {
  ...
  return _extends({}, other, {
    InputProps: _extends({}, InputProps, {
      endAdornment: (0, import_jsx_runtime11.jsxs)(React28.Fragment, {
...
var DateField = React39.forwardRef(function DateField2(inProps, inRef) {
  const themeProps = useThemeProps({
    props: inProps,
    name: "MuiDateField"
  });
...
var useMobilePicker = (_ref) => {
  ...
  const fieldRef = React57.useRef(null);
  const labelId = useId();
  const isToolbarHidden = ((_a = innerSlotProps == null ? void 0 : innerSlotProps.toolbar) == null ? void 0 : _a.hidden) ?? false;
  const {
    open,
